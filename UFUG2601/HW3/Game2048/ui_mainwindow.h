...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionResize33->setObjectName("actionResize33");
        actionResize44 = new QAction(MainWindow);
        actionResize44->setObjectName("actionResize44");
        actionResize55 = new QAction(MainWindow);
        actionResize55->setObjectName("actionResize55");
        actionResize66 = new QAction(MainWindow);
        actionResize66->setObjectName("actionResize66");
        actionResizeCustom = new QAction(MainWindow);
        actionResizeCustom->setObjectName("actionResizeCustom");
        actionThemeClassic = new QAction(MainWindow);
        actionThemeClassic->setObjectName("actionThemeClassic");
        ...
        actionShow_Rank->setObjectName("actionShow_Rank");
        actionChangePlayer = new QAction(MainWindow);
        actionChangePlayer->setObjectName("actionChangePlayer");
        actionUndo = new QAction(MainWindow);
        actionUndo->setObjectName("actionUndo");
        actionConfiguration_Panel = new QAction(MainWindow);
        actionConfiguration_Panel->setObjectName("actionConfiguration_Panel");
        actionResize88 = new QAction(MainWindow);
        actionResize88->setObjectName("actionResize88");
        actionPause = new QAction(MainWindow);
        actionPause->setObjectName("actionPause");
        actionBoard = new QAction(MainWindow);
        actionBoard->setObjectName("actionBoard");
        ...
        menuBoard_Size->setObjectName("menuBoard_Size");
