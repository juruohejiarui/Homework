...
QT_MOC_LITERAL(3, 19, 12) // "mouseClicked"

    },
    "GameBoard\0clicked\0\0mouseClicked"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::clicked)) {
                *result = 0;
                return;
            }
        }
